...
const allCommands: Command[] = [
  ...
  { id: 'exportExcel', label: 'Export as Excel (.xlsx)', icon: FileSpreadsheet, action: () => window.dispatchEvent(new CustomEvent('cmd:exportExcel')) },
  { id: 'exportMarkdown', label: 'Copy entire file as Markdown', icon: Copy, action: () => window.dispatchEvent(new CustomEvent('cmd:copyMarkdown')) },
  { id: 'exportJson', label: 'Copy entire file as JSON', icon: Copy, action: () => window.dispatchEvent(new CustomEvent('cmd:copyJson')) },
  { id: 'dlJson', label: 'Download as JSON', icon: FileText, action: () => window.dispatchEvent(new CustomEvent('cmd:downloadFormat', { detail: 'json' })) },
  { id: 'dlMarkdown', label: 'Download as Markdown', icon: FileText, action: () => window.dispatchEvent(new CustomEvent('cmd:downloadFormat', { detail: 'markdown' })) },
  { id: 'dlHtml', label: 'Download as HTML', icon: FileText, action: () => window.dispatchEvent(new CustomEvent('cmd:downloadFormat', { detail: 'html' })) },
  { id: 'dlSql', label: 'Download as SQL', icon: FileText, action: () => window.dispatchEvent(new CustomEvent('cmd:downloadFormat', { detail: 'sql' })) },
  { id: 'dlLatex', label: 'Download as LaTeX', icon: FileText, action: () => window.dispatchEvent(new CustomEvent('cmd:downloadFormat', { detail: 'latex' })) },
